...
export default function Main(props) {
  ...
  function onChangeTextoFiltro(event) {
    ...
    setMenu("procedimentos");
  }
  //Filtro de grupo selecionado
  const [grupoIdFiltro, setGrupoIdFiltro] = React.useState("");
  function handleSetGrupoIdFiltro(idGrupo) {
    if (idGrupo != "") {
      setMenu("procedimentos");
    }
    setGrupoIdFiltro(idGrupo);
  }
  ...
  const [menu, setMenu] = React.useState("procedimentos");
  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <Divider />
        <List>
          <Menu app={props.app} dados={props.dados} onClick={handleChangeMenu} menuExpandido={open} setGrupoIdFiltro={handleSetGrupoIdFiltro} />
        </List>
      </Drawer>
